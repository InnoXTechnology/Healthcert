<div style="clear:both;"></div>
	...
	<div class="container" style="margin-top:50px;">
		<div class="containerMain" style="min-height:400px;">
				...
				<div class="side" style="margin-top:30px">
					<legend1 style="color:#5BAF5B;">รายการคำขอแก้ไขใบแนบใบรับรองสุขอนามัย (พ.ก. 11)</legend1>
						...
						<table id="bgTable" border="1" cellspacing="1" cellpadding="6" width="780px" style="margin:auto;">
							...
							<tr align="center"><td><?= $request['EditRequest']['receipt_no']; ?></td><td><?php $date = date_create($request['EditRequest']['receipt_date']); ?><?= date_format($date, 'd F Y เวลา H:i น.'); ?></td><td><?= $request['Exporter']['name']; ?></td><td width="130px"><?= $this->Form->button('ดู', array('onclick' => "location.href='".$this->Html->url(array('action' => 'view_edit_report_pk11',$request['EditRequest']['id']))."'" ,'class' => 'btn', 'style' => 'width:50px;')); ?>&nbsp;<?= $this->Form->button('ลบ', array('onclick' => "if(confirm('Are you sure to delete?'))
